...
public class Transaction extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(acnotxt);
        acnotxt.setBounds(60, 90, 210, 31);
        ...
        jButton1.setBounds(290, 90, 100, 30);

        jLabel5.setFont(new java.awt.Font("Century", 0, 18)); // NOI18N
        jLabel5.setText("Name");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(400, 50, 60, 30);

        namelb.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        namelb.setMinimumSize(new java.awt.Dimension(70, 120));
        jPanel2.add(namelb);
        namelb.setBounds(400, 90, 200, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     CustomerTask.User user =new CustomerTask.User();
      String query="select * from emptransaction where Ac_no='"+user.customerno
